...
if __name__ == "__main__":
    ...
    print("Syed Ali Hasany")
    print("Dylan Laurianti")
    print("Ali Nasser")
    print("Tommy Subaric\n\n")

    print("============================> Original code Example 1")
    PrintCCode(loop0_ir)
    print("============================> Updated code")
    returned_ir0 = LoopTiling(loop0_ir, tile_size = [3,4,5])
    PrintCCode(returned_ir0)

    print("============================> Original code Example 2")
    PrintCCode(loop1_ir)
    print("============================> Updated code")
    returned_ir1 = LoopTiling(loop1_ir, tile_size = [3,4,5])
    PrintCCode(returned_ir1)
